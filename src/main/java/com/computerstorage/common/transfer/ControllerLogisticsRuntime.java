...
/** Server-side runtime bridge: persisted programs are executed against live world handlers. */
public final class ControllerLogisticsRuntime {
    ...
    public ControllerLogisticsRuntime(TransferProgramRepository repository,
                                      Function<String, IItemHandler> handlerResolver) {
        this.repository = repository;
        this.runner = new TransferTickRunner(repository, handlerResolver);
    }
